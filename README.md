...
image-20250102151823965

image-20250104123418192

image-20250105081555300
...
image-20240511093854203

将headless设置为True即可不弹出浏览器无浏览器运行，设置为False即可弹出浏览器运行，默认为True。

### 四、运行截图

image-20240509174326633

image-20240509190837212
